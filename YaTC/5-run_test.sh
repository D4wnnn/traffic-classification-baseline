...
# --- 4. 开始执行各数据集测试 ---
# 路径必须与 4-finetune.sh 中的定义完全对应
run_test "1" "CICIDS2017" \
...
# run_test "1" "aes_128" \
#     "./1-data_processing/outputs/finetune_data_chacha20-poly1305-Dataset" \
#     "./output/aes_128_gcm" # 53
# run_test "1" "aes_128" \
#     "./1-data_processing/outputs/finetune_data_mix-Dataset" \
#     "./output/aes_128_gcm" # 67
# run_test "1" "aes_128" \
#     "./1-data_processing/outputs/finetune_data_aes_128_gcm" \
#     "./output/chacha20_poly1305" # 56
# run_test "1" "aes_128" \
#     "./1-data_processing/outputs/finetune_data_mix-Dataset" \
#     "./output/chacha20_poly1305" # 60
# run_test "1" "aes_128" \
#     "./1-data_processing/outputs/finetune_data_aes_128_gcm" \
#     "./output/mix_Dataset" # 84
# run_test "1" "aes_128" \
#     "./1-data_processing/outputs/finetune_data_chacha20-poly1305-Dataset" \
#     "./output/mix_Dataset" # 81
