...
def get_args_parser():
    ...
    parser.add_argument(
        "--warmup_epochs", type=int, default=25, metavar="N", help="epochs to warmup LR"
    )

    # Dataset parameters
    parser.add_argument(
        "--data_path", default="./data/ISCXVPN2016_MFR", type=str, help="dataset path"
    )
...
def main(args):
    ...
    print(f"Resuming training from epoch {args.start_epoch}") # 添加一行日志
